      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav">
            ...
            <li className={`nav-item ${location.pathname === "/new-organization" ? "active" : ""}`}>
              <Link className="nav-link" to="/">Categories</Link>
            </li>
            <li className={`nav-item ${location.pathname === "/new-user" ? "active" : ""}`}>
              <Link className="nav-link" to="/profile"> Profile</Link>
            </li>
            <li className={`nav-item ${location.pathname === "/add-review-list" ? "active" : ""}`}>
